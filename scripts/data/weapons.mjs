...
let weapons = {
    ...
    "Beacon of the Reed Sea": new weapon("claymore", domainMaterial("scorching"), enemyDrop("shell"), enemyDrop("headband"), 5),
    ...
    "Ibis Piercer": new weapon("bow", domainMaterial("talisman"), enemyDrop("flower"), enemyDrop("headband"), 4),
    ...
    "Jadefall's Splendor": new weapon("catalyst", domainMaterial("guyun"), enemyDrop("flower"), enemyDrop("spores"), 5),
    ...
    "Light of Foliar Incision": new weapon("sword", domainMaterial("talisman"), enemyDrop("shell"), enemyDrop("headband"), 5),
    ...
    "Mailed Flower": new weapon("claymore", domainMaterial("dandelion"), enemyDrop("shell"), enemyDrop("spectral"), 4),
    ...
    "Toukabou Shigure": new weapon("sword", domainMaterial("narukami"), enemyDrop("prism_robot"), enemyDrop("handguard"), 4),
